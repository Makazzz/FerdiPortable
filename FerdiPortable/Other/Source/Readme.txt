...
user in an INI file next to FerdiPortable.exe called FerdiPortable.ini.
...
copy AppNamePortable.ini from this directory to FerdiPortable.ini next to
FerdiPortable.exe. The options in the INI file are as follows:
